...
const cases = [
  ...
  {
    name: "grade4-decimal-divide",
    path: "/apps/decimal-print-grade4/index.html",
    stateKey: "decimal-print-grade4-state-v1",
    scalePct: 130,
    settings: {
      title: "4 grade decimal division",
      type: "divideInteger",
      layout: "vertical",
      count: 8,
      columns: 2,
      showCarryBoxes: true,
      showAnswerDecimalPoint: false,
    },
  },
  {
    name: "grade5-decimal-divide",
    path: "/apps/decimal-print-grade5/index.html",
    stateKey: "decimal-print-grade5-state-v1",
    scalePct: 130,
    settings: {
      title: "5 grade decimal division",
      type: "divide",
      layout: "vertical",
      count: 8,
      columns: 2,
